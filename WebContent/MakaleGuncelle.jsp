                ...
                <div class="card">
                   <div class="card-content">
                     	...
                     	<%
							...
							while(Rs.next()){
								session.setAttribute("secili_alan", Rs.getString("alan_id"));
								session.setAttribute("makale_tut", Rs.getString("ad"));
							}
							
							session.setAttribute("makale_guncelle", id);
						%> 
                     	...
                     	<form enctype="multipart/form-data" action="dosyayukle.jsp" method="post">
							...
							<%}
								...
								<a href="articals/<%=session.getAttribute("makale_tut")%>" target="_blank" style="text-decoration: none;">
	         						<img alt="Qries" src="assets/pdf_image.png" width=70">
	      						</a>
      						<%} %>
                     	...
                     	<form action="VeriTabaniSorgu.jsp">
							...
							<div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="m_b" required="required" value=<%=Rs.getString("baslik")%>>
                            </div>
                            <%} %>
                            <div class="form-group">
                                ...
                                <select name="m_a_id" class="form-control custom-select my-1 mr-sm-2">
									<%Rs= Db.AlanGetir();
									while(Rs.next()){ %>
										<%if(Rs.getString("id").equals(session.getAttribute("secili_alan"))){%>
